...
export const defaultDishes: CarouselItem[] = [
  {
    ...
    titleLine1: "Cappotto",
    titleLine2: "Milano",
    desc: "Klassik to'g'ri qirqimli jun palto.",
    img: "/products/cappotto-milano-1.jpg",
    ctaText: "Ko'rish",
    ctaUrl: "/product/cappotto-milano",
  },
  {
    tag: "Kurtkalar",
    titleLine1: "Giacca",
    titleLine2: "Alpina",
    desc: "Suv o'tkazmaydigan ustki qatlam, issiq to'ldiruvchi.",
    img: "/products/giacca-alpina-1.jpg",
    ctaText: "Ko'rish",
    ctaUrl: "/product/giacca-alpina",
  },
  {
    tag: "Trikotaj",
    titleLine1: "Maglione",
    titleLine2: "Merino",
    desc: "Merinos junidan to'qilgan sviter.",
    img: "/products/maglione-merino-1.jpg",
    ctaText: "Ko'rish",
    ctaUrl: "/product/maglione-merino",
  },
];
