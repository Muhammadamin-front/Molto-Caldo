    ...
    <>
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-sm font-medium text-muted-foreground transition-all duration-500" style={{ opacity: isHovered ? 0.8 : 1 }}>{projects.length} {countLabel ?? (projects.length === 1 ? 'project' : 'projects')}</p>
        </div>
